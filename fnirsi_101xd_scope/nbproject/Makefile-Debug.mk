...
OBJECTFILES= \
	...
	${OBJECTDIR}/fnirsi_101xd_scope.o \
	${OBJECTDIR}/font_0.o \
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_101xd_scope.elf

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_101xd_scope.elf: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	arm-none-eabi-gcc -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fnirsi_101xd_scope.elf ${OBJECTFILES} ${LDLIBSOPTIONS} -T./fnirsi_101xd.ld -nostdlib -lgcc
...
${OBJECTDIR}/fnirsi_101xd_scope.o: fnirsi_101xd_scope.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fnirsi_101xd_scope.o fnirsi_101xd_scope.c
