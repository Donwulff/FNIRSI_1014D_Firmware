...
void ui_draw_pointers(void)
{
  ...
  if(scopesettings.channel1.enable)
  {
    ...
    else
    {
      ...
      //Draw the pointer
      display_top_pointer(position, TRACE_VERTICAL_START, '1');
    }
  }
  ...
  if(scopesettings.tracedisplaymode == DISPLAY_MODE_NORMAL)
  {
    ...
    {
      //Draw the pointer
      display_top_pointer(position - (HORIZONTAL_POINTER_WIDTH / 2), TRACE_VERTICAL_START, 'H');
    }
...
const UI_MEASUREMENTFUNCTION measurement_functions[] =
{
  ui_display_vmax,
  ui_display_vmin,
  ui_display_vavg,
...
void ui_unhighlight_main_menu_item(void)
{
  ...
  display_set_fg_color(COLOR_DARK_GREY_1);
  display_fill_rect(9, y - 1, 177, 28);
